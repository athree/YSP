...
#region 各部分相关定义
    ...
    {
        public Para_A p_a;    //气体修正参数A
        public Para_B p_b;    //气体修正参数B
    ...
    public class GasFixPara_CO2
    {
        public Para_A p_a;    //气体修正参数A
        public Para_B p_b;    //气体修正参数B

        [Display(Name = "多级K值")]
        public GasFixK MultiK { get; set; }  //CO2只有一份K值   所以拉出来单类 设置
...
#region  最小操作单元需要提出来的类，用于兼容define中定义的解析数据所需
    ...
    public class OilFactor
    {
        ...
        public float A { get; set; }            //油品系数A（4bytes）
